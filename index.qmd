...
Trong toán học, vật lý và kỹ thuật, vector hay hướng lượng (theo phiên âm Hán Việt) là một đoạn thẳng có hướng. Đoạn thẳng này biểu thị phương, chiều, độ lớn (chiều dài của vector). aaabbbcccVí dụ trong [mặt phẳng]{.underline} cho hai điểm phân biệt A và B bất kì ta có thể xác định được vector $\overrightarrow{AB}$
